...
sepsis=readtable('sepsis_mimiciii.csv');

%% ########################################################################
% IMPORT ALL DATA

tic
abx=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/abx.csv'));
culture=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/culture.csv'));
microbio=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/microbio.csv'));
demog=(readtable('/data4/tangsp/AI_Clinician/exportdir/demog.csv'));
ce010=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce010000.csv'));
ce1020=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce1000020000.csv'));
ce2030=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce2000030000.csv'));
ce3040=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce3000040000.csv'));
ce4050=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce4000050000.csv'));
ce5060=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce5000060000.csv'));
ce6070=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce6000070000.csv'));
ce7080=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce7000080000.csv'));
ce8090=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce8000090000.csv'));
ce90100=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/ce90000100000.csv'));
labU=[ table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/labs_ce.csv')) ; table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/labs_le.csv'))  ];
MV=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/mechvent.csv'));
inputpreadm=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/preadm_fluid.csv'));
inputMV=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/fluid_mv.csv'));
inputCV=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/fluid_cv.csv'));
vasoMV=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/vaso_mv.csv'));
vasoCV=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/vaso_cv.csv'));
UOpreadm=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/preadm_uo.csv'));
UO=table2array(readtable('/data4/tangsp/AI_Clinician/exportdir/uo.csv'));
toc
...
%     save('D:\BACKUP MIT PC\Data_100219.mat', '-v7.3');
    save('/data4/tangsp/AI_Clinician/Data_100219.mat', '-v7.3');
toc
...
%      save('D:\BACKUP MIT PC\Data_110219.mat', '-v7.3');
     save('/data4/tangsp/AI_Clinician/Data_110219.mat', '-v7.3');
toc
...
writetable(MIMICtable,'MIMICtable.csv','Delimiter',',');
