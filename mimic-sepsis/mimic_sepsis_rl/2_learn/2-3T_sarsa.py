...
def run_SARSA(trajectories, n_episodes, gamma, alpha=0.5, Q_init=None):
    ...
    for episode in tqdm(range(n_episodes)):
        ...
        for t, transition in enumerate(trajectory):
            ...
            if done:
                ...
                if np.isnan(Q[S_, A_]): # '{}, {}, {}, {}, {}'.format(S, A, R, S_, A_)
...
Q, metadata = run_SARSA(traj_tr, n_episodes, gamma, alpha)
np.save('sarsa_Q.npy', Q)
pickle.dump(metadata, open('sarsa_metadata.p', 'wb'))
